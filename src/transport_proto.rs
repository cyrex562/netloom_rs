...
impl From<TransSvcProto> for TransSvcProtoInfo {
    fn from(f : TransSvcProto) -> TransSvcProtoInfo {
        match f {
            TransSvcProto::NotSet => TransSvcProtoInfo {port: 0, trans_proto: vec![TransProto::NotSet]},
            TransSvcProto::FtpData => TransSvcProtoInfo {port: 20, trans_proto: vec![TransProto::Tcp, TransProto::Udp, TransProto::Sctp]},
            TransSvcProto::Ftp => TransSvcProtoInfo { port: 21, trans_proto: vec![TransProto::Tcp, TransProto::Udp, TransProto::Sctp]},
            TransSvcProto::Ssh => TransSvcProtoInfo { port: 22, trans_proto: vec![TransProto::Tcp, TransProto::Udp, TransProto::Sctp]},
            TransSvcProto::Telnet => TransSvcProtoInfo { port: 23, trans_proto: vec![TransProto::Tcp, TransProto::Udp, TransProto::Sctp]},
            TransSvcProto::Smtp => TransSvcProtoInfo { port: 25, trans_proto:vec![TransProto::Tcp, TransProto::Udp]},
            TransSvcProto::Domain => TransSvcProtoInfo { port: 53, trans_proto: vec![TransProto::Tcp, TransProto::Udp, TransProto::Sctp]},
        }
    }
} 